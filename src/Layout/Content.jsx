          ...
          <div className="max-w-md">
            <div className="mb-8">
              <div className="flex items-center justify-center gap-2 mb-2">
                <h1 className="text-4xl font-bold text-black">Spike</h1>
                <RiSparkling2Line className="w-8 h-8 text-black" />
              </div>
              <h2 className="text-2xl font-bold text-black typing-effect">
            ...
            <div className="flex flex-row gap-2">
              <input
                type="text"
                placeholder="🔍 URL"
                className="input input-bordered w-full max-w-xs bg-[#F3EBE5] text-black"
              />
              <button className="btn bg-[#F3EBE5] text-black">Run <RadixIconsRocket className="w-5 h-5"/></button>
            </div>
          </div>
        </div>
      </div>
